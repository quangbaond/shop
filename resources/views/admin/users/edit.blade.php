            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea type="text" value="{{ $user->address }}" id="address" name="address" class="form-control" placeholder="địa ch" >
                            {{ $user->address }}
                        </textarea>
                        <div class="help-block with-errors"></div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3 d-flex justify-content-center">
                        <label for="avatar">
                            <img src="{{ $user->avatar }}" id="avatar-user" class="rounded-circle border-3 border-dark" width="100" height="100">
                        </label>
